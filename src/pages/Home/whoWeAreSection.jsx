...
const whoWeAre= ()=> {
    return(
        ...
        <h2 className="text-4xl md:text-3xl lg:text-4xl font-bold text-primary mb-8 text-center md:pl-8">
         Who We Are
        </h2>
      
            <p className='m-5'>Welcome to NGO Name, where passion meets purpose to create positive change in the world. Founded in 2001, our non-profit organization is driven by a collective commitment to making a meaningful impact on the lives of those in need.</p>
